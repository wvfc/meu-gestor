Substitua o conteúdo de `.github/workflows/build-apk.yml` por este:
      ...
      - name: Create Release with APK
        ...
        with:
          ...
          body: |
            ...
            ### Como instalar:
            1. Baixe o arquivo **MeuGestor-v1.0.0-debug.apk** abaixo
            2. No celular, vá em **Configurações > Segurança > Fontes desconhecidas** e habilite
            3. Abra o arquivo APK baixado no celular
            4. Toque em **Instalar**
            ...
            - Lançamentos futuros e projeções
            - Relatórios e rankings de gastos
            - Organizador de Imposto de Renda
            - Metas de gastos com alertas
            - Patrimônio e reservas por banco
            - Modo escuro
            - 100% offline
          files: MeuGestor-v1.0.0-debug.apk
          draft: false
          prerelease: false
        env:
